...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      ...
      {\
        "name": "sidechain",\
        "reference": "workspace:packages/sidechain"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["bridge", ["workspace:packages/bridge"]],\
      ["cli", ["workspace:packages/cli"]],\
      ["client", ["workspace:packages/client"]],\
      ["orochi-monorepo", ["workspace:."]],\
      ["sidechain", ["workspace:packages/sidechain"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["sidechain", [\
        ["workspace:packages/sidechain", {\
          "packageLocation": "./packages/sidechain/",\
          "packageDependencies": [\
            ["sidechain", "workspace:packages/sidechain"]\
          ],\
          "linkType": "SOFT"\
